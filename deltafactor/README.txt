Delta_v3-1_0/
Taken from https://molmod.ugent.be/sites/default/files/Delta_v3-1_0.zip
...
Unpack the CIFs.tar.gz or primCIFs.tar.gz file and translate every CIF file into a structure input file of the code under investigation. Make similar input files for 94%, 96%, 98%, 102%, 104%, and 106% of the CIF file volume. For each elemental crystal this yields seven structures.
